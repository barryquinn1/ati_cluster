...
use_webcam()
use_panelset()
use_logo(image_url = "https://github.com/barryquinn1/FMLmaterial/blob/c06eec822b77fc1c2ccf2948515260fbadcea29e/slides/img/redlogo.png")
library(RefManageR)
library(tidyverse)
library(fpc)
library(factoextra)
...
BibOptions(check.entries = FALSE,
           ...
           hyperlink = FALSE,
           dashed = FALSE)
myBib <- ReadBib("~/Dropbox/Teaching/FinancialMachineLearning/FML/slides/assets/refs.bib", check = FALSE)
...
background-image: url(https://github.com/barryquinn1/FMLmaterial/blob/c06eec822b77fc1c2ccf2948515260fbadcea29e/slides/img/title-slide-img.png)
...
.pull-right[
<img src="~/Dropbox/Teaching/FinancialMachineLearning/FML/slides/img/agglom.png" width="80%">
]
...
---
class: middle
background-image: url(~/Dropbox/Teaching/FinancialMachineLearning/FML/slides/img/fifa20.png)
...
1. .saltinline[Connectivity:] This clustering is based on distance connectivity, like hierarchical clustering. Finance example = `r Citet(myBib, "Prado2016")`.

2. .saltinline[Centroids:] These algorithms perform a vector quantization, like k-means, Finance example = `r Citet(myBib, "Prado2018")`.
...
.pull-right[
<iframe src="~/Dropbox/Teaching/FinancialMachineLearning/FML/slides/img/p.html" width="100%" height="400" id="igraph" scrolling="no" seamless="seamless" frameBorder="0"> </iframe>
